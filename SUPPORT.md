...
Thanks for using glymotif! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/glycoverse/glymotif/issues/new).
...
requests](https://github.com/glycoverse/glymotif/issues) to make sure
