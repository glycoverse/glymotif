...
Use predefined motif names in the GlyGen GlycoMotif database (https://glycomotif.glyomics.org/glycomotif/GlycoMotif) instead:
...
Previously, we mentioned that you can use motif names in the GlycoMotif database (https://glycomotif.glyomics.org/glycomotif/GlycoMotif).
...
`have_motifs()`, `count_motifs()`, and `match_motifs()`.
