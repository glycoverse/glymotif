...
`extract_branch_motif()` allows you to automatically isolate the branches (antennae) from a set of N-glycans.

An N-glycan branch motif is defined as the substructure linked to either the a3- or a6-core-mannose.
...
This function is particularly useful to be combined with `glydet::quantify_motifs()`.
