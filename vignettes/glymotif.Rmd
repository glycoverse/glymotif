...
Previously, we mentioned that you can use motif names in the GlyGen GlycoMotif database (https://glycomotif.glyomics.org/glycomotif/GGM).
A common task is to match your glycans against all motifs in the database.
You can use `db_motifs()` for the `motifs` argument for this purpose:
...
You can use `db_motif_info()` to browse all built-in motifs.
