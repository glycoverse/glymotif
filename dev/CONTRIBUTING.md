...
This outlines how to propose a change to glymotif. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("glycoverse/glymotif", fork = TRUE)`.
...
Please note that the glymotif project is released with a [Contributor
Code of
Conduct](https://glycoverse.github.io/glymotif/dev/CODE_OF_CONDUCT.md).
